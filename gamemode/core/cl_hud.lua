...
/* VARIABLES */
local wardenMarkers = {}
wardenMarkers["generic"] = {text="Moverse",icon=Material("jailbreak_excl/pointers/generic.png")}
wardenMarkers["exclamation"] = {text="Ataquen",icon=Material("jailbreak_excl/pointers/exclamation.png")}
wardenMarkers["question"] = {text="Investigar",icon=Material("jailbreak_excl/pointers/question.png")}
wardenMarkers["line"] = {text="Hacer fila",icon=Material("jailbreak_excl/pointers/line.png")}
wardenMarkers["cross"] = {text="Alejarse",icon=Material("jailbreak_excl/pointers/cross.png")}
...
hook.Add("Think","JB.Think.PredictWardenFrame",function()
	...
	if IsValid(JB:GetWarden()) and not IsValid(warden) then
		...
		notification.AddLegacy(warden.Player:Nick().." es el warden",NOTICE_GENERIC);
	end
end);
