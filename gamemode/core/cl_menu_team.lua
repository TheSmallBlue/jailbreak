...
function JB.MENU_TEAM()
	...
	frame:SetTitle("Seleccion de equipo");
	...
	butGuard:SetText("Guardias ( "..#team.GetPlayers(TEAM_GUARD).." / "..JB:GetGuardsAllowed().." )");
	...
	butPrisoner:SetText("Prisioneros ( "..#team.GetPlayers(TEAM_PRISONER).." )");
