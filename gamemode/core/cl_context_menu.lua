...
concommand.Add( "+menu_context",function()
	if LocalPlayer().GetWarden and LocalPlayer():GetWarden() then
		...
		addBubble("Muevanse",Material("jailbreak_excl/pointers/generic.png"),function() RunConsoleCommand("jb_warden_placepointer","generic") end)
		addBubble("Ataquen",Material("jailbreak_excl/pointers/exclamation.png"),function() RunConsoleCommand("jb_warden_placepointer","exclamation") end)
		addBubble("Investiguen",Material("jailbreak_excl/pointers/question.png"),function() RunConsoleCommand("jb_warden_placepointer","question") end)
		addBubble("Hagan fila",Material("jailbreak_excl/pointers/line.png"),function() RunConsoleCommand("jb_warden_placepointer","line") end)
		addBubble("Aléjense",Material("jailbreak_excl/pointers/cross.png"),function() RunConsoleCommand("jb_warden_placepointer","cross") end)
		addBubble("Nada",nil,function() RunConsoleCommand("jb_warden_placepointer","0") end)
